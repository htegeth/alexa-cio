 ...
 * your function.
 */
public final class CioRequestStreamHandler extends SpeechletRequestStreamHandler {
    ...
    public CioRequestStreamHandler() {
        super(new CioSpeechlet(), supportedApplicationIds);
    }
}
